    ...
    <div class="min-h-screen bg-[#F7F6F1] flex items-center justify-center px-4 py-10">
        ...
        <div class="w-full max-w-4xl">
            ...
            <div class="text-center mb-8">
                ...
                <a href="{{ route('register') }}" class="inline-flex items-center gap-2 text-sm text-[#667085] hover:text-[#A85F76] mb-5">
                    ← Retour au choix de l'espace
                </a>

                <div class="flex justify-center items-center gap-2">
                    <div class="w-10 h-10 rounded-2xl bg-[#A85F76] text-white flex items-center justify-center">
                        🤝
                    </div>
            ...
            <div class="bg-white rounded-3xl border border-[#E5E1D8] shadow-sm p-6 md:p-8">
                ...
                <div class="mb-6 rounded-2xl bg-[#F8E9EE] border border-[#EBCFD8] p-4">
                ...
                <form method="POST" action="{{ route('register.proche.store') }}" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                                autofocus
                                class="w-full rounded-2xl border-[#D9D7CF] focus:border-[#A85F76] focus:ring-[#A85F76]"
                            >
                    ...
                    <button
                        type="submit"
                        class="w-full rounded-2xl bg-[#A85F76] px-6 py-3.5 text-white font-semibold hover:bg-[#934F67] transition"
                    >
