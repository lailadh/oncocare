        ...
        <div class="onco-container">
            ...
            <div class="onco-card">
                ...
                <div class="onco-card-header">
                    <div>
                        <h2>
                            Patients qui vous ont autorisé
                        </h2>

                        <p class="onco-card-description">
                            Vous pouvez consulter uniquement les informations pour lesquelles
                            le patient vous a donné l'autorisation.
                        </p>
                    </div>
                </div>
                ...
                @else
                    ...
                    <div class="onco-empty-state">
                        ...
                        <p>
                            Aucun patient ne vous a actuellement accordé d'autorisation
            ...
            <div class="onco-info-card role-proche">
                ...
                <div>
                    ...
                    <div class="onco-info-text">
                        ...
                        Vous pouvez accéder uniquement aux données explicitement
